...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename fov \
    op interface \
    ports { fov_address0 { O 21 vector } fov_ce0 { O 1 bit } fov_we0 { O 1 bit } fov_d0 { O 32 vector } fov_address1 { O 21 vector } fov_ce1 { O 1 bit } fov_we1 { O 1 bit } fov_d1 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'fov'"
}
}
