...
#ifndef __convert_mul_64s_6ocq__HH__
#define __convert_mul_64s_6ocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convert_mul_64s_6ocq) {
    ...
    SC_CTOR(convert_mul_64s_6ocq):  ACMP_mul_su_U ("ACMP_mul_su_U") {
