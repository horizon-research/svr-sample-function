...
#ifndef __convert_mul_42ns_ncg__HH__
#define __convert_mul_42ns_ncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convert_mul_42ns_ncg) {
    ...
    SC_CTOR(convert_mul_42ns_ncg):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
