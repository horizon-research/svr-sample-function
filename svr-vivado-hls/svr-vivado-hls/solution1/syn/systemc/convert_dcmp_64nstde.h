...
#ifndef __convert_dcmp_64nstde__HH__
#define __convert_dcmp_64nstde__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convert_dcmp_64nstde) {
    ...
    SC_CTOR(convert_dcmp_64nstde):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
