...
#ifndef __convert_mul_49ns_mb6__HH__
#define __convert_mul_49ns_mb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convert_mul_49ns_mb6) {
    ...
    SC_CTOR(convert_mul_49ns_mb6):  ACMP_mul_us_U ("ACMP_mul_us_U") {
