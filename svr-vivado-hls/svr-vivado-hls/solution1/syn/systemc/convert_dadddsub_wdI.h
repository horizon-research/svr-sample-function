...
#ifndef __convert_dadddsub_wdI__HH__
#define __convert_dadddsub_wdI__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convert_dadddsub_wdI) {
    ...
    SC_CTOR(convert_dadddsub_wdI):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
