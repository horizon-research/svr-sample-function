...
#ifndef __convert_mul_49ns_kbM__HH__
#define __convert_mul_49ns_kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convert_mul_49ns_kbM) {
    ...
    SC_CTOR(convert_mul_49ns_kbM):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
