...
#ifndef __convert_mul_56ns_lbW__HH__
#define __convert_mul_56ns_lbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convert_mul_56ns_lbW) {
    ...
    SC_CTOR(convert_mul_56ns_lbW):  ACMP_mul_us_U ("ACMP_mul_us_U") {
