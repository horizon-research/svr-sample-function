...
#ifndef __convert_mul_170nsibs__HH__
#define __convert_mul_170nsibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convert_mul_170nsibs) {
    ...
    SC_CTOR(convert_mul_170nsibs):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
