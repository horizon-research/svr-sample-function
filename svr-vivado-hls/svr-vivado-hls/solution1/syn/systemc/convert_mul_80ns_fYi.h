...
#ifndef __convert_mul_80ns_fYi__HH__
#define __convert_mul_80ns_fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convert_mul_80ns_fYi) {
    ...
    SC_CTOR(convert_mul_80ns_fYi):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
