...
#ifndef __convert_faddfsub_qcK__HH__
#define __convert_faddfsub_qcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convert_faddfsub_qcK) {
    ...
    SC_CTOR(convert_faddfsub_qcK):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
