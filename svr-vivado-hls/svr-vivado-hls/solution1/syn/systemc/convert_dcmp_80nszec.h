...
#ifndef __convert_dcmp_80nszec__HH__
#define __convert_dcmp_80nszec__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convert_dcmp_80nszec) {
    ...
    SC_CTOR(convert_dcmp_80nszec):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
