...
#ifndef __convert_fcmp_32nsncg__HH__
#define __convert_fcmp_32nsncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convert_fcmp_32nsncg) {
    ...
    SC_CTOR(convert_fcmp_32nsncg):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
