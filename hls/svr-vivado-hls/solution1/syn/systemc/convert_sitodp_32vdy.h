...
#ifndef __convert_sitodp_32vdy__HH__
#define __convert_sitodp_32vdy__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(convert_sitodp_32vdy) {
    ...
    SC_CTOR(convert_sitodp_32vdy):  ACMP_sitodp_U ("ACMP_sitodp_U") {
