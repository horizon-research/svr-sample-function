...
#ifndef __convert_sitofp_32rcU__HH__
#define __convert_sitofp_32rcU__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(convert_sitofp_32rcU) {
    ...
    SC_CTOR(convert_sitofp_32rcU):  ACMP_sitofp_U ("ACMP_sitofp_U") {
