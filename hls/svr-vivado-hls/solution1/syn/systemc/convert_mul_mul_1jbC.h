...
#ifndef __convert_mul_mul_1jbC__HH__
#define __convert_mul_mul_1jbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convert_mul_mul_1jbC) {
    ...
    SC_CTOR(convert_mul_mul_1jbC):  ACMP_smul_su_U ("ACMP_smul_su_U") {
