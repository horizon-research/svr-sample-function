...
#ifndef __convert_uitofp_32lbW__HH__
#define __convert_uitofp_32lbW__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(convert_uitofp_32lbW) {
    ...
    SC_CTOR(convert_uitofp_32lbW):  ACMP_uitofp_U ("ACMP_uitofp_U") {
